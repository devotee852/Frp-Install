...
show_help() {
    echo -e "${BLUE}================================${NC}"
    echo -e "${BLUE}      Frp 管理脚本             ${NC}"
    echo -e "${BLUE}================================${NC}"
    echo -e "用法: $0 [选项]"
    echo -e ""
    echo -e "选项:"
    echo -e "  install     安装 frp 服务端 (默认)"
    echo -e "  uninstall   完全卸载 frp"
    echo -e "  help        显示此帮助信息"
    echo -e ""
    echo -e "示例:"
    echo -e "  $0              # 安装 frp"
    echo -e "  $0 install      # 安装 frp"
    echo -e "  $0 uninstall    # 卸载 frp"
    echo -e ""
    echo -e "安装后管理:"
    echo -e "  frp           # 进入交互式管理菜单"
...
show_completion_info() {
    ...
    echo -e ""
    echo -e "卸载命令: ${RED}$0 uninstall${NC}"
    echo -e ""
